...
현대 엠엔소프트 산학 연구과제 <br/>
학생 5명 교수 1명 <br/>
역할 : 팀원, 컨텍스트 중요도 평가 / UI디자인 / 아이디에이션을 통한 사용자 시나리오 제작<br/>
...
<blockquote class="smallQuote"> "상황 컨텍스트를 구성하는 프레임워크 및 관계망 시각화툴 개발" - SOLUTION </blockquote>
